# Save the main code as a .py file for GitHub
code = """
import json
import os
...
def generate_answer(query, retrieved_docs, max_length=250):
    ...
    if not is_answer_relevant(answer, query):
        print("Generated answer was irrelevant. Falling back to retrieved information.")
...
if __name__ == "__main__":
    ...
    for doc, score in zip(retrieved_docs, scores):
        print(f"Score: {score:.2f}, Source: {doc['source']}, Disease: {doc.get('disease', 'N/A')}, Text: {doc['text'][:100]}...")
    answer = generate_answer(query, retrieved_docs)
    print("\\nGenerated Answer:", answer)
"""

# Save the code
with open("healthrag_system.py", "w") as file:
    file.write(code)
print("Code saved as healthrag_system.py")
