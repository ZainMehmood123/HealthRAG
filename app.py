...
#     answer_start = answer.find("Answer the query based on the relevant information provided above:\n") + len("Answer the query based on the relevant information provided above:\n")
#     if answer_start != -1:
